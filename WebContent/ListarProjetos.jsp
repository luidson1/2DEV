...
<body>
	...
	<form action="/Listar_Servicos.java" method="post" target="_parent">
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="0">
			<tbody>
						...
						<table border="1" cellspacing="0" cellpadding="0">
							...
							<tbody>
								...
								<tr>
									...
									<td><a
										href="editarServico.jsp?id=<%=servico.getCodigo()%>">Editar</a>
									</td>
									<td><a
										href="ExcluirTarefa.jsp?id=<%=servico.getCodigo()%>">Excluir</a>
									</td>
								</tr>
								<%
									} // fecha for
				...
				<tr>
					<td><form
							action="http://localhost:8085/2DEVS/Listar_Servicos.java"
							name="listaCidades" method="post">
